/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 098373056a176cdb93b65d13afed773e)
// Runtime types generated with workerd@1.20260801.1 2026-08-08 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	NEW_API_BASE_URL: "https://mediocre-new-api.midway.run/v1/chat/completions";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEW_API_BASE_URL" | "TIKHUB_API_KEY" | "INGEST_TOKEN" | "NEW_API_KEY">> {}
}
